// app/routes/subjects/higher_math_1st/chapter-selection-page.tsx
...
export default function ChapterSelectionHigherMath1st() {
  const navigate = useNavigate();
  const [isDemo, setIsDemo] = useState(false);
  const containerRef = useRef<HTMLDivElement>(null);

  // unique identifier for this page’s scroll position
  const mapKey = "highermathp1scrollpos";
  ...
  const chapters = [
    { route: "/highermath/1st-paper/ch-1", title: "Chapter 1", subtitle: "Kinematics" },
    { route: "/highermath/1st-paper/ch-2", title: "Chapter 2", subtitle: "Dynamics" },
    { route: "/highermath/1st-paper/ch-3", title: "Chapter 3", subtitle: "Work & Energy" },
    { route: "/highermath/1st-paper/ch-4", title: "Chapter 4", subtitle: "Momentum" },
    { route: "/highermath/1st-paper/ch-5", title: "Chapter 5", subtitle: "Rotational Motion" },
    { route: "/highermath/1st-paper/ch-6", title: "Chapter 6", subtitle: "Gravitation" },
    { route: "/highermath/1st-paper/ch-7", title: "Chapter 7", subtitle: "Properties of Matter" },
    { route: "/highermath/1st-paper/ch-8", title: "Chapter 8", subtitle: "Thermodynamics" },
    { route: "/highermath/1st-paper/ch-9", title: "Chapter 9", subtitle: "Oscillations" },
    { route: "/highermath/1st-paper/ch-10", title: "Chapter 10", subtitle: "Waves" },
  ];
