...
export default function chemistry() {
  ...
  const navigateToPaper = (paper: string) => {
    navigate(`/chemistry/${paper}`);
  };

  // Capitalize the first letter for mobile display
    ...
    <div className="relative min-h-screen bg-gray-800 text-white p-6 flex flex-col items-center">
      ...
      <div className="flex flex-col items-center text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full max-w-md">
          {/* Light green buttons */}
          <button className="bg-green-400 hover:bg-green-500 text-white py-3 px-6 rounded-lg transition" onClick={() => navigateToPaper("1st-paper")}>
            1st Paper
          </button>
          <button className="bg-green-400 hover:bg-green-500 text-white py-3 px-6 rounded-lg transition" onClick={() => navigateToPaper("2nd-paper")}>
            2nd Paper
          </button>
        </div>
      </div>
